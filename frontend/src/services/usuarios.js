...
export const getNiveisAcesso = async () => {
  ...
  const data = await response.json();
  if (!response.ok) throw Object.assign(new Error(data.error || 'Erro ao listar níveis de acesso'), { status: response.status });
  return data;
};
...
export const getNivelAcessoById = async (id) => {
  ...
  const data = await response.json();
  if (!response.ok) throw Object.assign(new Error(data.error || 'Erro ao obter nível de acesso'), { status: response.status });
  return data;
};
...
export const createNivelAcesso = async (payload) => {
  ...
  const data = await response.json();
  if (!response.ok) throw Object.assign(new Error(data.error || 'Erro ao criar nível de acesso'), { status: response.status });
  return data;
};
...
export const updateNivelAcesso = async (id, payload) => {
  ...
  const data = await response.json();
  if (!response.ok) throw Object.assign(new Error(data.error || 'Erro ao atualizar nível de acesso'), { status: response.status });
  return data;
};
...
export const deleteNivelAcesso = async (id) => {
  ...
  const data = await response.json();
  if (!response.ok) throw Object.assign(new Error(data.error || 'Erro ao deletar nível de acesso'), { status: response.status });
  return data;
};
