 ...
 * - Integração com API backend (POST /api/register)
...
const Register = () => {
  ...
  const [tipoUsuario, setTipoUsuario] = useState('usuario'); // Valor padrão
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userData = {
        name: name.trim(),
        email: email.trim().toLowerCase(), // Email em minúsculas
        password: password,
